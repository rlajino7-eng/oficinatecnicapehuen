...
function renderizarDirectorioActual() {
    ...
    // Si hay texto en el buscador, hacemos una búsqueda global en TODO el repositorio
    if (buscador) {
        ...
        if (vistaPreferida === 'lista') {
            grilla.style.display = 'flex'; grilla.style.flexDirection = 'column'; grilla.style.gap = '8px';
        } else {
            grilla.style.display = 'grid'; grilla.style.gridTemplateColumns = 'repeat(auto-fill, minmax(220px, 1fr))'; grilla.style.gap = '20px';
        }

        // Filtrar globalmente carpetas y archivos que coincidan con el buscador
        ...
        // Renderizar carpetas encontradas
        ...
        // Renderizar archivos encontrados en la tabla
